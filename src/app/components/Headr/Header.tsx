...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* Carrinho Lateral */}
      <aside className={`fixed right-0 top-0 h-full w-80 bg-white shadow-lg z-50 p-4 overflow-y-auto transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex justify-between items-center">
